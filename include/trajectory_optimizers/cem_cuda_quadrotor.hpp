#ifndef CEM_CUDA_QUADROTOR_HPP
#define CEM_CUDA_QUADROTOR_HPP
...
namespace trajectory_optimizers_quadrotor{
    class CEM_CUDA_quadrotor : public trajectory_optimizers::CEM{
        public:

            CEM_CUDA_quadrotor(enhanced_system_t* model, unsigned int number_of_samples, unsigned int number_of_t,
            ...
            CEM_CUDA_quadrotor(enhanced_system_t* model, unsigned int num_of_problems, unsigned int number_of_samples, unsigned int number_of_t,
                unsigned int number_of_elite,  double converge_r,
            ...
            virtual ~CEM_CUDA_quadrotor(){
                //std::cout << "inside CEM_CUDA_quadrotor deallication" << std::endl;
                ...
                {
                    //std::cout << "CEM_CUDA_quadrotor: destroying d_sum_control" << std::endl;
                ...
                delete[] loss_ind;
                delete[] loss;
                //std::cout << "after CEM_CUDA_quadrotor deallication" << std::endl;
