#ifndef CEM_CUDA_CARTPOLE_HPP
#define CEM_CUDA_CARTPOLE_HPP
...
namespace trajectory_optimizers_cartpole{
    class CEM_CUDA_cartpole : public trajectory_optimizers::CEM{
        public:

            CEM_CUDA_cartpole(enhanced_system_t* model, unsigned int number_of_samples, unsigned int number_of_t,
            ...
            CEM_CUDA_cartpole(enhanced_system_t* model, unsigned int num_of_problems, unsigned int number_of_samples, unsigned int number_of_t,
                unsigned int number_of_elite,  double converge_r,
            ...
            virtual ~CEM_CUDA_cartpole(){
                //std::cout << "inside CEM_CUDA_cartpole deallication" << std::endl;
                ...
                {
                    //std::cout << "CEM_CUDA_cartpole: destroying d_sum_control" << std::endl;
                ...
                delete[] loss_ind;
                delete[] loss;
                //std::cout << "after CEM_CUDA_cartpole deallication" << std::endl;
