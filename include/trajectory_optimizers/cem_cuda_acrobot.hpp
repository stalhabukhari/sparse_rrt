#ifndef CEM_CUDA_ACROBOT_HPP
#define CEM_CUDA_ACROBOT_HPP
...
namespace trajectory_optimizers_acrobot{
    class CEM_CUDA_acrobot : public trajectory_optimizers::CEM{
        public:

            CEM_CUDA_acrobot(enhanced_system_t* model, unsigned int number_of_samples, unsigned int number_of_t,
            ...
            CEM_CUDA_acrobot(enhanced_system_t* model, unsigned int num_of_problems, unsigned int number_of_samples, unsigned int number_of_t,
                unsigned int number_of_elite,  double converge_r,
            ...
            virtual ~CEM_CUDA_acrobot(){
                //std::cout << "inside CEM_CUDA_acrobot deallication" << std::endl;
                ...
                {
                    //std::cout << "CEM_CUDA_acrobot: destroying d_sum_control" << std::endl;
                ...
                delete[] loss_ind;
                delete[] loss;
                //std::cout << "after CEM_CUDA_acrobot deallication" << std::endl;
